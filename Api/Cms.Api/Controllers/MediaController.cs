...
public class MediaController : ControllerBase
{
    ...
    {
        var id = await _mediator.Send(new UploadMediaCommands(request.File));
        return Ok(id);
    }
    ...
    {
        var media = await _mediator.Send(new GetMediaQuery(id));
        return Ok(media);
    }
    ...
    {
        await _mediator.Send(new DeleteMediaCommand(id));
        return Ok();
    }
    ...
    {
        var list = await _mediator.Send(new LIstMediaQuery());
        return Ok(list);
    }
}
